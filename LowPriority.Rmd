...
---
*Data through 27 Nov 2022*
```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE)
library(tidyverse)
library(knitr)
books <- read_csv("data/goodreads_library_export_20221127.csv",
