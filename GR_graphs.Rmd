...
*Data through 1 Mar 2023*
```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning=FALSE)
library(tidyverse)
library(lubridate)
library(knitr)
books <- read_csv("data/goodreads_library_export_20230301.csv",
...
rereads <- books %>% 
      filter(`Read Count` > 1) %>%
      arrange(`Date Read`) %>% # Run up to here when fixing above table
