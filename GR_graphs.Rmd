...
*Data through 28 Jan 2023*
```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning=FALSE)
library(tidyverse)
library(lubridate)
library(knitr)
books <- read_csv("data/goodreads_library_export_20230128.csv",
...
reread_dates <- tribble(
      ...
      NA, # Hobbit
      "2022-09-24", # Hobbit
      "2017-05-20", # Little Prince
      "2020-12-21", # Little Prince
      NA, # Fahrenheit 451
      NA, # Night
      "2021-08-12", # Wrinkle in Time
      "2018-05-26", # Sun and Her Flowers
      "2019-08-21", # Sun and Her Flowers
      NA, # Brave New World
      "2020-12-02", # Brave New World
